...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Decision.organization'
        db.add_column('publicweb_decision', 'organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['organizations.Organization']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Decision.organization'
        db.delete_column('publicweb_decision', 'organization_id')
