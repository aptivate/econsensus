...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('publicweb_feedback', 'rating', self.gf('django.db.models.fields.IntegerField')())


    def backwards(self, orm):
        
        # Changing field 'Feedback.rating'
        db.alter_column('publicweb_feedback', 'rating', self.gf('django.db.models.fields.IntegerField')(null=True))
