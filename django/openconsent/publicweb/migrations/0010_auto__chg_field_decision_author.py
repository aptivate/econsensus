...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Decision.author'
        db.alter_column('publicweb_decision', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))


    def backwards(self, orm):
        
        # Changing field 'Decision.author'
        db.alter_column('publicweb_decision', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))
