...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Decision.created_date'
        db.add_column('publicweb_decision', 'created_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2011, 11, 14), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Decision.created_date'
        db.delete_column('publicweb_decision', 'created_date')
    ...
    models = {
        ...
        'publicweb.decision': {
            ...
            'created_date': ('django.db.models.fields.DateField', [], {'blank': 'True'}),
