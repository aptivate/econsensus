...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Decision.created_date'
        db.alter_column('publicweb_decision', 'created_date', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Decision.created_date'
        db.alter_column('publicweb_decision', 'created_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2011, 11, 14)))
