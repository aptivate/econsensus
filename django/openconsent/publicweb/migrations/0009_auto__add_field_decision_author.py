...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Decision.author'
        db.add_column('publicweb_decision', 'author', self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='open_consent_author', blank=True, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Decision.author'
        db.delete_column('publicweb_decision', 'author_id')
    ...
    models = {
        ...
        'publicweb.decision': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'open_consent_author'", 'blank': 'True', 'to': "orm['auth.User']"}),
