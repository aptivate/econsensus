...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('publicweb_decision', 'deadline', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Removing M2M table for field subscribers on 'Decision'
        db.delete_table('publicweb_decision_subscribers')
    ...
    def backwards(self, orm):
        ...
        db.delete_column('publicweb_decision', 'deadline')

        # Adding M2M table for field subscribers on 'Decision'
        db.create_table('publicweb_decision_subscribers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('decision', models.ForeignKey(orm['publicweb.decision'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('publicweb_decision_subscribers', ['decision_id', 'user_id'])
