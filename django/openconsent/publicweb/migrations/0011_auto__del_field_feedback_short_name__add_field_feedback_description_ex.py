...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Feedback.short_name'
        db.delete_column('publicweb_feedback', 'short_name')
        ...
        # Deleting field 'Decision.short_name'
        db.delete_column('publicweb_decision', 'short_name')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Feedback.short_name'
        db.add_column('publicweb_feedback', 'short_name', self.gf('django.db.models.fields.CharField')(default=' ', max_length=255), keep_default=False)

        # Deleting field 'Feedback.description_excerpt'
        db.delete_column('publicweb_feedback', 'description_excerpt')

        # Adding field 'Decision.short_name'
        db.add_column('publicweb_decision', 'short_name', self.gf('django.db.models.fields.CharField')(default=' ', max_length=255), keep_default=False)
    ...
    models = {
        ...
        'publicweb.decision': {
            ...
            'description_excerpt': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
