...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field watch_list on 'Decision'
        db.create_table('publicweb_decision_watch_list', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('decision', models.ForeignKey(orm['publicweb.decision'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('publicweb_decision_watch_list', ['decision_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field watch_list on 'Decision'
        db.delete_table('publicweb_decision_watch_list')
    ...
    models = {
        ...
        'publicweb.decision': {
            ...
            'watch_list': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['auth.User']", 'symmetrical': 'False'})
        },
        'publicweb.feedback': {
