...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Decision.tags'
        db.add_column('publicweb_decision', 'tags', self.gf('tagging.fields.TagField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Decision.tags'
        db.delete_column('publicweb_decision', 'tags')
