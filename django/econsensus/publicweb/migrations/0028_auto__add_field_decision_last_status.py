...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Decision.last_status'
        db.add_column('publicweb_decision', 'last_status',
                      self.gf('django.db.models.fields.CharField')(default='proposal', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Decision.last_status'
        db.delete_column('publicweb_decision', 'last_status')
    ...
    models = {
        ...
        'publicweb.decision': {
            ...
            'last_status': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '10'}),
