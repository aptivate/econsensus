...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('publicweb_feedback', 'editor',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='publicweb_feedback_edited', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Feedback.editor'
        db.delete_column('publicweb_feedback', 'editor_id')
