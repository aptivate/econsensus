...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Decision.last_modified'
        db.add_column('publicweb_decision', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Decision.last_modified'
        db.delete_column('publicweb_decision', 'last_modified')
