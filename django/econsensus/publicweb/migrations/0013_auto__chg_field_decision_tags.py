...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Decision.tags'
        db.alter_column('publicweb_decision', 'tags', self.gf('tagging.fields.TagField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Decision.tags'
        db.alter_column('publicweb_decision', 'tags', self.gf('tagging.fields.TagField')(default='', max_length=255))
