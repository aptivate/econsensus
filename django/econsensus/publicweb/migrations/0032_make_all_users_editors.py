...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        #Every User is given the 'edit_decisions_feedback' Permission for
        ...
        try:
            perm = Permission.objects.get(codename='edit_decisions_feedback')
        except:
            print "Couldn't get Permission 'edit_decisions_feedback'."
            raise
    ...
    def backwards(self, orm):
        ...
        for org in Organization.objects.all():
            for user in org.users.all():
                remove_perm(perm.codename, user, org)
