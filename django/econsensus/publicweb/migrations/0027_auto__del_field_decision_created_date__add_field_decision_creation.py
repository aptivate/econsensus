...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Decision.creation'
        db.add_column('publicweb_decision', 'creation',
    ...
    def backwards(self, orm):
        ...
        db.add_column('publicweb_decision', 'created_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Decision.creation'
        db.delete_column('publicweb_decision', 'creation')
