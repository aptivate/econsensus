...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('publicweb_feedback', 'description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Decision.description'
        db.alter_column('publicweb_decision', 'description', self.gf('django.db.models.fields.TextField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Feedback.description'
        db.alter_column('publicweb_feedback', 'description', self.gf('tinymce.models.HTMLField')(default='generic description'))

        # Changing field 'Decision.description'
        db.alter_column('publicweb_decision', 'description', self.gf('tinymce.models.HTMLField')())
