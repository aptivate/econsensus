...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Decision.status'
        db.alter_column('publicweb_decision', 'status', self.gf('django.db.models.fields.CharField')(max_length=10))


    def backwards(self, orm):
        
        # Changing field 'Decision.status'
        db.alter_column('publicweb_decision', 'status', self.gf('django.db.models.fields.IntegerField')())
