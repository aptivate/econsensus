...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Decision.editor'
        db.add_column('publicweb_decision', 'editor',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='publicweb_decision_edited', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Decision.editor'
        db.delete_column('publicweb_decision', 'editor_id')
